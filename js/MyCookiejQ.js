...
$(document).ready(function() {
    ...
    var textCookie = 'Nasza strona internetowa korzysta z plików cookies (tzw. ciasteczek) w celach statystycznych, reklamowych oraz funkcjonalnych. Dzięki nim możemy indywidualnie dostosować stronę do twoich potrzeb. Każdy może zaakceptować pliki cookies albo ma możliwość wyłączenia ich w przeglądarce, dzięki czemu nie będą zbierane żadne informacje.';
    
    //zmienna textClose definuje tekst zamknięcia panelu cookies
    var textClose = 'Close X';
